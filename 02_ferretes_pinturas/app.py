...
class App(customtkinter.CTk):
    ...
    def btn_convertir_c_f_on_click(self):
        ...
        temp_celsius = (fahrenheit_numero - 32) * 5/9
        alert(title="", message="La temperatura es " + str(temp_celsius) + " °C")


    def btn_convertir_f_c_on_click(self):
        celsius_texto = self.txt_temperatura_c.get()
        celsius_numero = int(celsius_texto)
        temp_fahrenheit = (celsius_numero * 9/5) + 32
        alert(title="", message="La temperatura es " + str(temp_fahrenheit) + " °F")
